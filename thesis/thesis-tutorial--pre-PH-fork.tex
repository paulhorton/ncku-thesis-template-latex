...
\newcommand*\UniversityNameChi{國立成功大學}
\newcommand*\UniversityNameEng{National Cheng Kung University}

\newcommand*\ThesisTitleChi{碩博士用畢業論文LaTex模版}
\newcommand*\ThesisTitleEng{Thesis/Dissertation Template in LaTex}

\newcommand*\AuthorNameChi{你的名字}
\newcommand*\AuthorNameEng{Your name}

\newcommand*\AdvisorNameChiA{Ａ}
\newcommand*\AdvisorNameEngA{A}

\newcommand*\AdvisorNameChiB{Ｂ}
\newcommand*\AdvisorNameEngB{B}

\newcommand*\AdvisorNameChiC{Ｃ}
\newcommand*\AdvisorNameEngC{C}

\newcommand*\CoverDate{31 December 2019}

\newcommand*\ForPhD

\newcommand*\optDOI% Embed DOI number into document at bottom right.
