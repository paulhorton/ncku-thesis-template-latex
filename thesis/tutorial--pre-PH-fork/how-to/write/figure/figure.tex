...
圖片為兩類別: 點陣圖或向量圖 (參考 Fig \RefTo{fig:how-to:write:figure:format}) .\\
  ...
  \InsertFigure
    ...
    {tutorial--pre-PH-fork/how-to/write/figure/pic/graph-format.png}
...
\StartSubSection{單張}
  ...
  \item
  {
    ...
    \end{verbatim}
    \InsertFigure
      {tutorial--pre-PH-fork/how-to/write/figure/pic/Cc-by_new.png}
  } % End of \item{}
  ...
  \item
  {
    ...
    \begin{tabular}{|c|c|}
      ...
      \begin{tabular}[c]{@{}c@{}}
      \includegraphics[scale=0.1]
       {tutorial--pre-PH-fork/how-to/write/figure/pic/apple.jpg} \\ Apple
      \end{tabular} & \url{www.apple.com}  \\ \hline

      \begin{tabular}[c]{@{}c@{}}
      \includegraphics[scale=0.1]
        {tutorial--pre-PH-fork/how-to/write/figure/pic/google.png} \\ Google
      \end{tabular} & \url{www.google.com} \\ \hline
    \end{tabular}
    \end{table}
...
%    \newpage
    ...
    {
      [caption = {Figure 3}]
      {tutorial--pre-PH-fork/how-to/write/figure/pic/CC-BY-NC-SA.png}
    }%
  ...
  \item
  {
    ...
    }%
    {
      ...
      {tutorial--pre-PH-fork/how-to/write/figure/pic/CC-BY-ND.png}
    }
  ...
  \item
  {
    ...
    [perrow = 2,
      caption = {8 figures and 2 figures per row}] %
    {[caption = { }]{tutorial--pre-PH-fork/how-to/write/figure/pic/CC-BY.png}}%
    {[caption = { }]{tutorial--pre-PH-fork/how-to/write/figure/pic/CC-BY-NC.png}}%
    {[caption = { }]{tutorial--pre-PH-fork/how-to/write/figure/pic/CC-BY-ND.png}}%
    {[caption = { }]{tutorial--pre-PH-fork/how-to/write/figure/pic/CC-BY-SA.png}}%
    {[caption = { }]{tutorial--pre-PH-fork/how-to/write/figure/pic/CC-BY.png}}%
    {[caption = { }]{tutorial--pre-PH-fork/how-to/write/figure/pic/CC-BY-NC.png}}%
    {[caption = { }]{tutorial--pre-PH-fork/how-to/write/figure/pic/CC-BY-ND.png}}%
    {[caption = { }]{tutorial--pre-PH-fork/how-to/write/figure/pic/CC-BY-SA.png}}
